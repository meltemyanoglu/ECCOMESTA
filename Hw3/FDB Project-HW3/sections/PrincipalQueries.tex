...
\begin{enumerate}
    \item For each store, get its id, the list of products that need to be bought (id and name) and the minimum quantity
    \item For each customer in the loyalty program, get its email, the list of products that currently have a promotion on their preferred store, the discount info and the start and end dates of the promotion
    \item For each cashier, get their surname and name, the id of the store they work for and how many times has a customer used the loyalty program when they were attending at the register, and how many of them were unique customers
    \item For each store, get its id and the percentage of products bought ordered by category during the current month
    \item Obtain the category from which women between 40 and 60 years old buy the most products (and quantity)
\end{enumerate}
...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.8\textwidth]{sections/pictures/Q1.png}    
\end{center}
...
\end{lstlisting}
\begin{center}
\includegraphics[width=1\textwidth]{sections/pictures/Q2.png}    
\end{center}
...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.9\textwidth]{sections/pictures/Q3.png}    
\end{center}
...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.6\textwidth]{sections/pictures/Q4_1.png}   \includegraphics[width=0.6\textwidth]{sections/pictures/Q4_2.png}
\end{center}
...
\end{lstlisting}
\begin{center}
\includegraphics[width=0.6\textwidth]{sections/pictures/Q5.png}    
\end{center}