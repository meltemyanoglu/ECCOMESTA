        ...
        try {
            ...
            try {
                if (resset1 != null || resset2 != null) {
                    ...
                    System.out.printf("%nResult sets are successfully closed in final block in %,d 
                ...
                if (st1 != null || st2 != null) {
                    ...
                    System.out.printf("%nStatements are successfully closed in final block in %,d 
                    milliseconds.", end - start);
                }
                if (con != null) {
                    start = System.currentTimeMillis();
                    ...
                    System.out.printf("%nConnection successfully closed in final block in %,d 
...
\begin{center}
\includegraphics[width=1\textwidth]{sections/pictures/JDBC Q1 (SQL Q3).PNG}   
\includegraphics[width=0.58\textwidth]{sections/pictures/JDBC Q2-1 (SQL Q4).PNG}
\includegraphics[width=0.58\textwidth]{sections/pictures/JDBC Q2-2 (SQL Q4).PNG}
\end{center}