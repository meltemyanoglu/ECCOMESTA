...
COMMENT ON TABLE Stores IS 'Represents the quantity of a specific product stored in a store and its re-order level.';
...
COMMENT ON COLUMN Promotion.start-enddates IS 'Initial and final date of a promotion.';
