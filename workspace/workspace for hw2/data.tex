\begin{longtable}{|p{.15\columnwidth}|p{.15\columnwidth} |p{.30\columnwidth}|p{.10\columnwidth}|p{.20\columnwidth} |} 
    ...
    &UPC &Universal Product Code, standardized barcode symbology used for tracking items & Long & Not NULL\\\cline{2-5}
    &Name &Name of the product&Text&Not NULL \\\cline{2-5}
    &VAT &Value Added Tax &Float &Not NULL \\\cline{2-5}
    ...
    \multirow{2}{*}{\textbf{BELONGS TO}} 
    &Email & Email of the customer & Text & Foreign Key to Customer, Primary Key with ReceiptID\\\cline{2-5}
    &ReceiptID & Identification of the receipt & Serial & Foreign Key to Receipt, Primary Key with Email, not NULL \\\hline
    
    \multirow{4}{*}{\textbf{PROMOTION}} 
    &Start-EndDates &Initial and final date of a promotion &Datetime &Not NULL \\\cline{2-5}
    ...
    &DateOfBirth &Date of Birth of the customer &Datetime &Not NULL \\\cline{2-5}
    ...
    &Quantity &Quantity of product bought &Int &Not NULL \\\cline{2-5}
    ...
    \multirow{5}{*}{\textbf{SUPPLIER}} 
    &SupplierID &Identification of the supplier &Serial &Primary Key, Not NULL \\\cline{2-5}
    &Address &Address of the supplier & Text&Not NULL \\\cline{2-5}
    &Phone &Phone number of the supplier & Text &Not NULL \\\cline{2-5}
    &Email &Email of the supplier & Text &Not NULL \\\cline{2-5}
    ...
    &Schedule &Timetable of the store &Datetime &Not NULL \\\cline{2-5}
    ...
    &HireDate &Date of the hire of the employee &Datetime &Not NULL \\\cline{2-5}
    &Salary &Salary of the employee &Float &Not NULL \\\cline{2-5}
