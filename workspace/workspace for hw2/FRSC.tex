...
The system must allow:
  ...
  Store managers to input stock quantities for products, to track reorder levels for products and to transfer stock from one store to another
  ...
  \item\textbf{Product Information Management}
   \begin{itemize}
     \item   Store managers to input detailed product information, such as product ID, name, UPC, VAT, and price
         \item Store managers to track the location of each product within their store
   ...
   \begin{itemize}
    ...
    \item\textbf{Category and Supplier Management }
     \begin{itemize}
     \item  Store managers to input detailed category information, such as category ID and name
         \item Store managers to input detailed supplier information, such as supplier ID, name, contact information, and contract details
    ...
    \end{itemize}
     ...
     \item\textbf{Promotion and Discount Management }
      \begin{itemize}
     \item  Store managers to input detailed promotion and discount information, such as discount type, percentage, or amount
...
Store managers to generate various types of reports, such as sales reports, inventory reports, and employee performance reports
